...
require 'syncano/notifications/base'
require 'syncano/notifications/create'
require 'syncano/notifications/update'
require 'syncano/notifications/destroy'
require 'syncano/notifications/message'